# Migration `20201108222415-updated-metrics`

This migration has been generated by mcsdevv at 11/8/2020, 10:24:15 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."tweets" DROP COLUMN "favorites",
ADD COLUMN "impressions" integer   NOT NULL DEFAULT 0,
ADD COLUMN "quote_retweets" integer   NOT NULL DEFAULT 0,
ADD COLUMN "likes" integer   NOT NULL DEFAULT 0,
ADD COLUMN "url_clicks" integer   NOT NULL DEFAULT 0,
