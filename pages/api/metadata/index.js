...
const getCardMetadata = async (req, res) => {
  try {
    ...
    let post = {
      ...
      twitter_app_name_iphone: $('meta[name="twitter:app:name:iphone"]').attr(
        "content"
      ),
      twitter_app_id_iphone: $('meta[name="twitter:app:id:iphone"]').attr(
        "content"
      ),
      twitter_app_url_iphone: $('meta[name="twitter:app:url:iphone"]').attr(
        "content"
      ),
      twitter_app_name_ipad: $('meta[name="twitter:app:name:ipad"]').attr(
        "content"
      ),
      twitter_app_id_ipad: $('meta[name="twitter:app:id:ipad"]').attr(
        "content"
      ),
      twitter_app_url_ipad: $('meta[name="twitter:app:url:ipad"]').attr(
        "content"
      ),
      twitter_card: $('meta[name="twitter:card"]').attr("content"),
      twitter_creator: $('meta[name="twitter:creator"]').attr("content"),
      twitter_creator_id: $('meta[name="twitter:creator:id"]').attr("content"),
      twitter_description: $('meta[name="twitter:description"]').attr(
        "content"
      ),
      twitter_domain: $('meta[name="twitter:domain"]').attr("content"),
      twitter_img: $('meta[name="twitter:image"]').attr("content"),
      twitter_img_alt: $('meta[name="twitter:image:alt"]').attr("content"),
      twitter_img_src: $('meta[name="twitter:image:src"]').attr("content"),
      twitter_player: $('meta[name="twitter:player"]').attr("content"),
      twitter_player_height: $('meta[name="twitter:player:height"]').attr(
        "content"
      ),
      twitter_player_stream: $('meta[name="twitter:player:stream"]').attr(
        "content"
      ),
      twitter_player_width: $('meta[name="twitter:player:width"]').attr(
        "content"
      ),
      twitter_site: $('meta[name="twitter:site"]').attr("content"),
      twitter_site_id: $('meta[name="twitter:site:id"]').attr("content"),
